"""
  ...
  using the minimax algorithm. I did use ai including microsoft copilot 
  and chat gpt to ASSIST me in building this program.I have provided 
  numerous comments to express my understanding of my code. I spent an 
  extraordiary amount of time on this project to get it up and running 
  properly. I am proud of what I built and all that I 
